...
class NMC111(OCPbase):
    def __init__(self):
        ...
        self.NMC111_COMSOL = interp1d(table['θs'], table['UOCP'])
        ...
        self.NMC111_52_Schmalstieg2018 = interp1d(table['θs'], table['UOCP'])
